...
AreTomo -InMrc {position_directory}/{position_prefix}_unaligned.mrc -OutMrc {position_directory}/{position_prefix}.mrc -VolZ {aretomo_thickness} -OutBin {aretomo_volume_binning} -TiltCor 1 -AngFile {position_directory}/{position_prefix}.rawtlt -DarkTol {aretomo_DarkTol} -AlignZ {aretomo_AliZ}  -OutImod 2 -FlipVol 1
